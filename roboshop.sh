...
do
   INSTANCE_ID=$( aws ec2 run-instances --image-id ami-09c813fb71547fc4f --instance-type t2.micro --security-group-ids sg-0df304cc4c6711e85 --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=test}]' 
